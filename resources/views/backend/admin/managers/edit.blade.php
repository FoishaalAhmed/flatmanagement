            ...
            <div id="basic" class="col-lg-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        ...
                        <form method="post" action="{{ route('admin.managers.update', $manager->id) }}" method="POST"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control form-small tagging" multiple="multiple"
                                                    ...
                                                    @foreach ($buildings as $item)
                                                        <option value="{{ $item->id }}" @if (in_array($item->id, $buildingUser)) {{ 'selected' }} @endif>
                                                            {{ $item->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" placeholder="{{ __('Address') }}"
                                                    rows="3" name="address"
                                                    autocomplete="off">{{ $manager->address }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
