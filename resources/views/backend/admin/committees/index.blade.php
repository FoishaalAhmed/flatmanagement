                    ...
                    <div class="widget-header">
                        <div class="row">
                            <div class="col-xl-6 col-md-6 col-sm-6 col-6">
                                <h4>{{ __('All Committee') }}</h4>
                            </div>
                            <div class="col-xl-6 col-md-6 col-sm-6 col-6 text-right">
                                <a class="btn btn-outline-primary mb-2"
                                    href="{{ route('admin.committees.create') }}">{{ __('New Committee') }}</a>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-outline-primary mb-2 bs-tooltip"
                                                href="{{ route('admin.committees.edit', $item->id) }}"
                                            ...
                                            <form action="{{ route('admin.committees.destroy', [$item->id]) }}"
