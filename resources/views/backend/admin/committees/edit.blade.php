...
@section('title', 'Update Committee')
@section('content')
            ...
            <div id="basic" class="col-lg-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        ...
                        <form method="post" action="{{ route('admin.committees.update', $committee->id) }}" method="POST"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control form-small tagging" name="building_id" required>
                                                    @foreach ($buildings as $item)
                                                        <option value="{{ $item->id }}" @if ($item->id == $committee->building_id) {{ 'selected' }} @endif>
                                                            {{ $item->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-lg-6 col-12 mx-auto">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control"
                                                    ...
                                                    autocomplete="off">{{ $committee->present_address }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-12 mx-auto">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control"
                                                    ...
                                                    autocomplete="off">{{ $committee->permanent_address }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="education layout-spacing ">
                                        <div class="widget-content widget-content-area">
                                            ...
                                            <div class="text-center user-info">
                                                <img src="{{ asset($committee->photo) }}" alt="avatar"
                                                    id="committee-photo">
                                                <p class="text-danger">
