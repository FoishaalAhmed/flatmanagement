                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-md-6 col-sm-6 col-6 text-right">
                                <a class="btn btn-outline-primary mb-2"
                                    href="{{ route('admin.owners.create') }}">{{ __('New Owner') }}</a>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @foreach ($item->flats as $flat)
                                                <span class="shadow-none badge badge-primary">{{ $flat->name }}</span>
                                            @endforeach
                                        </td>
                                        <td>
                                            <div class="d-flex">
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-outline-primary mb-2 bs-tooltip"
                                                href="{{ route('admin.owners.edit', $item->id) }}"
                                            ...
                                            <form action="{{ route('admin.owners.destroy', [$item->id]) }}"
